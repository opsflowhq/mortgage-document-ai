...
export const documentModel: DocumentModel<EntityId> = {
    //Section 1a
    application: {
        label: "Application information",
        fields: {
            loanNumber: { key: EntityId.LENDER_LOAN_NUMBER, label: "Lender loan no." },
            agencyCaseNumber: { key: EntityId.AGENCY_CASE_NUMBER, label: "Agency case no." }
        }
    },
    borrower: {
        label: "Borrower information (1a)",
        fields: {
            name: { key: EntityId.BORROWER_NAME_1A, label: "Name" },
            ssn: { key: EntityId.BORROWER_SOCIAL_SECURITY_NUMBER_1A, label: "SSN" },
            dob: { key: EntityId.BORROWER_DATE_OF_BIRTH_1A, label: "Date of Birth" },
            dependentsNumber: {
                key: EntityId.BORROWER_DEPENDANTS_NUMBER_1A,
                label: "Dependents number",
            },
            dependentsAges: {
                key: EntityId.BORROWER_DEPENDANTS_AGES_1A,
                label: "Dependents ages",
            },
            phoneHome: { key: EntityId.BORROWER_HOME_PHONE_1A, label: "Home phone" },
            phoneCell: { key: EntityId.BORROWER_CELL_PHONE_1A, label: "Cell phone" },
            phoneWork: { key: EntityId.BORROWER_WORK_PHONE_1A, label: "Work phone" },
            email: { key: EntityId.BORROWER_EMAIL_1A, label: "Email" },
        },
    },
    currentAddress: {
        ...
        fields: {
            street: {
                key: EntityId.BORROWER_CURRENT_ADDRESS_STREET_1A,
                label: "Street",
            },
            unit: {
                key: EntityId.BORROWER_CURRENT_ADDRESS_UNIT_1A,
                label: "Unit",
            },
            city: { key: EntityId.BORROWER_CURRENT_ADDRESS_CITY_1A, label: "City" },
            state: {
                key: EntityId.BORROWER_CURRENT_ADDRESS_STATE_1A,
                label: "State",
            },
            zip: { key: EntityId.BORROWER_CURRENT_ADDRESS_ZIP_1A, label: "ZIP" },
            country: {
                key: EntityId.BORROWER_CURRENT_ADDRESS_COUNTRY_1A,
                label: "Country",
            },
            livedYears: {
                key: EntityId.BORROWER_CURRENT_ADDRESS_LIVED_YEARS_1A,
                label: "Lived years",
            },
            livedMonths: {
                key: EntityId.BORROWER_CURRENT_ADDRESS_LIVED_MONTHS_1A,
                label: "Lived months",
            },
            rentPrice: {
                key: EntityId.BORROWER_CURRENT_ADDRESS_RENT_PRICE_1A,
                label: "Rent price",
            },
        },
    },
    formerAddress: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.BORROWER_FORMER_ADDRESS_DOESNT_APPLY_1A,
                label: "Does not apply",
            },
            street: {
                key: EntityId.BORROWER_FORMER_ADDRESS_STREET_1A,
                label: "Street",
            },
            unit: {
                key: EntityId.BORROWER_FORMER_ADDRESS_UNIT_1A,
                label: "Unit",
            },
            city: { key: EntityId.BORROWER_FORMER_ADDRESS_CITY_1A, label: "City" },
            state: {
                key: EntityId.BORROWER_FORMER_ADDRESS_STATE_1A,
                label: "State",
            },
            zip: { key: EntityId.BORROWER_FORMER_ADDRESS_ZIP_1A, label: "ZIP" },
            country: {
                key: EntityId.BORROWER_FORMER_ADDRESS_COUNTRY_1A,
                label: "Country",
            },
            livedYears: {
                key: EntityId.BORROWER_FORMER_ADDRESS_LIVED_YEARS_1A,
                label: "Lived years",
            },
            livedMonths: {
                key: EntityId.BORROWER_FORMER_ADDRESS_LIVED_MONTHS_1A,
                label: "Lived months",
            },
            rentPrice: {
                key: EntityId.BORROWER_FORMER_ADDRESS_RENT_PRICE_1A,
                label: "Rent price",
            },
        },
    },
    mailingAddress: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.BORROWER_MAILING_ADDRESS_DOESNT_APPLY_1A,
                label: "Does not apply",
            },
            street: {
                key: EntityId.BORROWER_MAILING_ADDRESS_STREET_1A,
                label: "Street",
            },
            unit: {
                key: EntityId.BORROWER_MAILING_ADDRESS_UNIT_1A,
                label: "Unit",
            },
            city: { key: EntityId.BORROWER_MAILING_ADDRESS_CITY_1A, label: "City" },
            state: {
                key: EntityId.BORROWER_MAILING_ADDRESS_STATE_1A,
                label: "State",
            },
            zip: { key: EntityId.BORROWER_MAILING_ADDRESS_ZIP_1A, label: "ZIP" },
            country: {
                key: EntityId.BORROWER_MAILING_ADDRESS_COUNTRY_1A,
                label: "Country",
            },
        },
    },
    ...
    currentEmployment: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.CURRENT_EMPLOYMENT_DOES_NOT_APPLY_1B,
                label: "Doesn't apply",
            },
            employerName: {
                key: EntityId.CURRENT_EMPLOYMENT_NAME_1B,
                label: "Employer name",
            },
            phone: {
                key: EntityId.CURRENT_EMPLOYMENT_PHONE_1B,
                label: "Employer phone",
            },
            position: {
                key: EntityId.CURRENT_EMPLOYMENT_POSITION_OR_TITLE_1B,
                label: "Position or title",
            },
            startDate: {
                key: EntityId.CURRENT_EMPLOYMENT_START_DATE_1B,
                label: "Start date",
            },
            lineOfWorkYears: {
                key: EntityId.CURRENT_EMPLOYMENT_LINE_OF_WORK_YEARS_1B,
                label: "In this line of work (years)",
            },
            lineOfWorkMonth: {
                key: EntityId.CURRENT_EMPLOYMENT_LINE_OF_WORK_MONTHS_1B,
                label: "In this line of work (months)",
            },
            isBusinessOwner: {
                key: EntityId.CURRENT_EMPLOYMENT_BUSINESS_OWNER_OR_SELF_EMPLOYED_1B,
                label: "Is business owner",
            },
            hasMajorityOwnership: {
                key: EntityId.CURRENT_EMPLOYMENT_OWNERSHIP_SHARE_MORE_25_1B,
                label: "Has ownership of 25% or more",
            },
            hasMinorityOwnership: {
                key: EntityId.CURRENT_EMPLOYMENT_OWNERSHIP_SHARE_LESS_25_1B,
                label: "Has ownership of less than 25%",
            },
            employedByFamilyMember: {
                key: EntityId.CURRENT_EMPLOYMENT_EMPLOYED_BY_FAMILY_MEMBER_1B,
                label: "Employed by family member",
            },
            monthlyIncome: {
                key: EntityId.CURRENT_EMPLOYMENT_MONTHLY_INCOME_OR_LOSS_1B,
    ...
    currentEmploymentAddress: {
        ...
        fields: {
            street: { key: EntityId.CURRENT_EMPLOYMENT_STREET_1B, label: "Street" },
            unit: { key: EntityId.CURRENT_EMPLOYMENT_UNIT_1B, label: "Unit" },
            city: { key: EntityId.CURRENT_EMPLOYMENT_CITY_1B, label: "City" },
            state: { key: EntityId.CURRENT_EMPLOYMENT_STATE_1B, label: "State" },
            zip: { key: EntityId.CURRENT_EMPLOYMENT_ZIP_1B, label: "Zip" },
            country: {
                key: EntityId.CURRENT_EMPLOYMENT_COUNTRY_1B,
                label: "Country",
            },
        },
    },
    currentEmploymentGrossMonthlyIncome: {
        ...
        fields: {
            base: {
                key: EntityId.CURRENT_EMPLOYMENT_GROSS_MONTHLY_INCOME_BASE_1B,
                label: "Base",
            },
            overtime: {
                key: EntityId.CURRENT_EMPLOYMENT_GROSS_MONTHLY_INCOME_OVERTIME_1B,
                label: "Overtime",
            },
            bonus: {
                key: EntityId.CURRENT_EMPLOYMENT_GROSS_MONTHLY_INCOME_BONUS_1B,
                label: "Bonus",
            },
            commission: {
                key: EntityId.CURRENT_EMPLOYMENT_GROSS_MONTHLY_INCOME_COMMISSION_1B,
                label: "Commission",
            },
            military: {
                key: EntityId.CURRENT_EMPLOYMENT_GROSS_MONTHLY_INCOME_MILITARY_1B,
                label: "Military entitlements",
            },
            other: {
                key: EntityId.CURRENT_EMPLOYMENT_GROSS_MONTHLY_INCOME_OTHER_1B,
                label: "Other",
            },
            total: {
                key: EntityId.CURRENT_EMPLOYMENT_GROSS_MONTHLY_INCOME_TOTAL_1B,
                label: "Total",
            },
        },
    },
    ...
    additionalEmployment: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_DOES_NOT_APPLY_1C,
                label: "Doesn't apply",
            },
            employerName: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_NAME_1C,
                label: "Employer name",
            },
            phone: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_PHONE_1C,
                label: "Employer phone",
            },
            position: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_POSITION_OR_TITLE_1C,
                label: "Position or title",
            },
            startDate: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_START_DATE_1C,
                label: "Start date",
            },
            lineOfWorkYears: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_LINE_OF_WORK_YEARS_1C,
                label: "In this line of work (years)",
            },
            lineOfWorkMonth: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_LINE_OF_WORK_MONTHS_1C,
                label: "In this line of work (months)",
            },
            isBusinessOwner: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_OWNER_OR_SELF_EMPLOYED_1C,
                label: "Is business owner",
            },
            hasMajorityOwnership: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_HAVE_MORE_THAN_25_OWNERSHIP_1C,
                label: "Has ownership of 25% or more",
            },
            hasMinorityOwnership: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_HAVE_LESS_THAN_25_OWNERSHIP_1C,
                label: "Has ownership of less than 25%",
            },
            employedByFamilyMember: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_EMPLOYED_BY_FAMILY_MEMBER_1C,
                label: "Employed by family member",
            },
            monthlyIncome: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_MONTHLY_INCOME_1C,
                label: "Monthly income or loss",
            },
        },
    },
    additionalEmploymentAddress: {
        ...
        fields: {
            street: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_STREET_1C,
                label: "Street",
            },
            unit: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_UNIT_1C,
                label: "Unit",
            },
            city: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_CITY_1C,
                label: "City",
            },
            state: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_STATE_1C,
                label: "State",
            },
            zip: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_ZIP_1C,
                label: "Zip",
            },
            country: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_BUSINESS_COUNTRY_1C,
                label: "Country",
            },
        },
    },
    additionalEmploymentGrossMonthlyIncome: {
        ...
        fields: {
            base: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_GROSS_MONTHLY_INCOME_BASE_1C,
                label: "Base",
            },
            overtime: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_GROSS_MONTHLY_INCOME_OVERTIME_1C,
                label: "Overtime",
            },
            bonus: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_GROSS_MONTHLY_INCOME_BONUS_1C,
                label: "Bonus",
            },
            commission: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_GROSS_MONTHLY_INCOME_COMMISION_1C,
                label: "Commission",
            },
            military: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_GROSS_MONTHLY_INCOME_MILITARY_1C,
                label: "Military entitlements",
            },
            other: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_GROSS_MONTHLY_INCOME_OTHER_1C,
                label: "Other",
            },
            total: {
                key: EntityId.ADDITIONAL_EMPLOYMENT_GROSS_MONTHLY_INCOME_TOTAL_1C,
                label: "Total",
            },
        },
    },
    ...
    previousEmployment: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.PREVIOUS_EMPLOYMENT_DOES_NOT_APPLY_1D,
                label: "Doesn't apply",
            },
            employerName: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_NAME_1D,
                label: "Employer name",
            },
            position: {
                key: EntityId.PREVIOUS_EMPLOYMENT_POSITION_OR_TITLE_1D,
                label: "Position or title",
            },
            startDate: {
                key: EntityId.PREVIOUS_EMPLOYMENT_START_DATE_1D,
                label: "Start date",
            },
            endDate: {
                key: EntityId.PREVIOUS_EMPLOYMENT_END_DATE_1D,
                label: "End date",
            },
            isBusinessOwner: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_OWNER_OR_SELF_EMPLOYED_1D,
                label: "Is business owner",
            },
            grossMonthlyIncome: {
                key: EntityId.PREVIOUS_EMPLOYMENT_GROSS_MONTHLY_INCOME_1D,
    ...
    previousEmploymentAddress: {
        ...
        fields: {
            street: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_STREET_1D,
                label: "Street",
            },
            unit: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_UNIT_1D,
                label: "Unit",
            },
            city: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_CITY_1D,
                label: "City",
            },
            state: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_STATE_1D,
                label: "State",
            },
            zip: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_ZIP_1D,
                label: "Zip",
            },
            country: {
                key: EntityId.PREVIOUS_EMPLOYMENT_BUSINESS_COUNTRY_1D,
                label: "Country",
            },
        },
    },
    ...
    otherIncome: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.INCOME_FROM_OTHER_SOURCES_DOES_NOT_APPLY_1E,
                label: "Does not apply",
            },
            sources: {
                label: "Income sources",
                key: EntityId.INCOME_FROM_OTHER_SOURCES_1E,
                isArray: true,
                fields: {
                    name: {
                        label: "Source name",
                        key: EntityId["INCOME_FROM_OTHER_SOURCES_1E:INCOME_SOURCE_NAME"],
                    },
                    monthlyIncome: {
                        label: "Monthly income",
                        key: EntityId["INCOME_FROM_OTHER_SOURCES_1E:MONTHLY_INCOME"]
                    }
                },
            },
            totalMonthlyIncome: {
                key: EntityId.INCOME_FROM_OTHER_SOURCES_TOTAL_AMOUNT_1E,
    ...
    primaryAssets: {
        ...
        fields: {
            assets: {
                key: EntityId.ASSET_ACCOUNT_2A,
                label: "Assets",
                isArray: true,
                fields: {
                    accountType: { key: EntityId['ASSET_ACCOUNT_2A:ACCOUNT_TYPE'], label: "Account type" },
                    financialInstitution: { key: EntityId['ASSET_ACCOUNT_2A:FINANCIAL_INSTITUTION'], label: "Financial institution" },
                    accountNumber: { key: EntityId['ASSET_ACCOUNT_2A:ACCOUNT_NUMBER'], label: 'Account number' },
                    cashOrMarketValue: { key: EntityId['ASSET_ACCOUNT_2A:CASH_OR_MARKET_VALUE'], label: "Cash or Market Value" }
                }
            },
            totalAmount: {
                key: EntityId.ASSET_ACCOUNTS_TOTAL_VALUE_2A,
                label: "Total amount"
            }
        }
    },
    ...
    otherAssets: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.OTHER_ASSETS_AND_CREDIT_DOES_NOT_APPLY_2B,
                label: "Does not apply",
            },
            assets: {
                key: EntityId.OTHER_ASSET_OR_CREDIT_2B,
                label: "Assets",
                isArray: true,
                fields: {
                    assetType: { key: EntityId['OTHER_ASSET_OR_CREDIT_2B:ASSET_OR_CREDIT_TYPE'], label: "Asset type" },
                    cashOrMarketValue: { key: EntityId['OTHER_ASSET_OR_CREDIT_2B:CASH_OR_MARKET_VALUE'], label: "Cash or Market Value" }
                }
            },
            totalAmount: {
                key: EntityId.OTHER_ASSETS_AND_CREDITS_TOTAL_AMOUNT_2B,
                label: "Total amount"
            }
        }
    },
    ...
    primaryLiabilities: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.LIABILITIES_DOES_NOT_APPLY_2C,
                label: "Does not apply",
            },
            assets: {
                key: EntityId.LIABILITY_2C,
                label: "Liabilities",
                isArray: true,
                fields: {
                    accountType: { key: EntityId['LIABILITY_2C:ACCOUNT_TYPE'], label: "Account type" },
                    companyName: { key: EntityId['LIABILITY_2C:COMPANY_NAME'], label: "Company name" },
                    accountNumber: { key: EntityId['LIABILITY_2C:ACCOUNT_NUMBER'], label: "Account number" },
                    unpaidBalance: { key: EntityId['LIABILITY_2C:UNPAID_BALANCE'], label: "Unpaid balance" },
                    toBePaidOffBeforeClosing: { key: EntityId['LIABILITY_2C:TO_BE_PAID_OFF_AT_OR_BEFORE_CLOSING'], label: "To be paid before closing" },
                    monthlyPayment: { key: EntityId['LIABILITY_2C:MONTHLY_PAYMENT'], label: "Monthly payment" },
                }
            }
        }
    },
    ...
    otherLiabilities: {
        ...
        fields: {
            doesNotApply: {
                key: EntityId.OTHER_LIABILITIES_AND_EXPENSES_DOES_NOT_APPLY_2D,
                label: "Does not apply",
            },
            assets: {
                key: EntityId.OTHER_LIABILITY_AND_EXPENSES_2D,
                label: "Liabilities",
                isArray: true,
                fields: {
                    liabilityType: { key: EntityId['OTHER_LIABILITY_AND_EXPENSES_2D:LIABILITY_NAME'], label: "Liability type" },
                    monthlyPayment: { key: EntityId['OTHER_LIABILITY_AND_EXPENSES_2D:MONTHLY_PAYMENT'], label: "Monthly payment" },
                }
            }
        }
    }
